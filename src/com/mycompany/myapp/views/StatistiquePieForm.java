...
{
    DefaultRenderer rendrer = new DefaultRenderer();
    
    rendrer.setLabelsTextSize(15);
    rendrer.setLegendTextSize(15);
    rendrer.setMargins(new int[]{20,30,15,0});
    
    for (int color:colors)
    {
    SimpleSeriesRenderer simpleSeriesRenderer =new SimpleSeriesRenderer();
    rendrer.addSeriesRenderer(simpleSeriesRenderer);
